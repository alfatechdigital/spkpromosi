  <style>
    .background {
      background: linear-gradient(to bottom, transparent 0%, black 100%), url(<?= base_url('assets/img/loginBG/sbc.jpg'); ?>);
    ...
    <div class="row justify-content-center">
      <div class="col-lg-9 col-sm-9 mt-4">
        <div class="text-center">
          <h3 class="text-white mb-4"><b>SISTEM PENDUKUNG KEPUTUSAN PEMILIHAN KATEGORI PROMOSI PRODUK MENGGUNAKAN METODE PROFILE MATCHING STUDI KASUS PADA SBC GROUP</b></h3>
        </div>
      </div>
